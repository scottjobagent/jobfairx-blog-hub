...
**Backlinks to add after publish (this is the flagship, so this pass matters most):** from recruiting-metrics (show rate section), cost-per-hire (funnel paragraph), why-hospitals-struggle (speed section), and the virtual-hiring-events pillar — anchor "virtual hiring event statistics."
